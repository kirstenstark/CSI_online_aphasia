---
title: "Power Analysis for CSI online typing with patients with aphasia - Summary using simple contrast coding for the Session"
...
```{r LMM_full}
# compute SIMPLE CODING contrast: Intercept is grand mean and each level is compared to the reference level (the first session)
c <- contr.treatment(3)
my.coding<-matrix(rep(1/3, 6), ncol=2)
my.simple<-c-my.coding
(contrasts(df_full$repet)<-my.simple)
...
fixef(lmm24_20_Stark)["OrdPos.c:repet2"]<- eff_40ms
fixef(lmm24_20_Stark)["OrdPos.c:repet3"]<- eff_40ms
```
...
PowerLMM1_Interaction24_20_Stark <- powerSim(lmm24_20_Stark, test=fixed("OrdPos.c:repet2","t"), nsim = n_iter) # increase to nsim > 1000 for real test
lastResult()$warnings
lastResult()$errors
``` 
...
PowerLMM1_Interaction24_20_Stark <- powerSim(lmm24_20_Stark, test=fixed("OrdPos.c:repet3","t"), nsim = n_iter) # increase to nsim > 1000 for real test
lastResult()$warnings
lastResult()$errors
``` 
...
fixef(lmm24_20_Stark)["OrdPos.c:repet2"]<- eff_45ms
fixef(lmm24_20_Stark)["OrdPos.c:repet3"]<- eff_45ms
```
...
PowerLMM1_Interaction45_20 <- powerSim(lmm24_20, test=fixed("OrdPos.c:repet2","t"), nsim = n_iter) # increase to nsim > 1000 for real test
lastResult()$warnings
lastResult()$errors
``` 
...
PowerLMM1_Interaction45_20 <- powerSim(lmm24_20, test=fixed("OrdPos.c:repet3","t"), nsim = n_iter) # increase to nsim > 1000 for real test
lastResult()$warnings
lastResult()$errors
``` 
...
PowerLMM1_Interaction45_20_Stark <- powerSim(lmm24_20_Stark, test=fixed("OrdPos.c:repet2","t"), nsim = n_iter) # increase to nsim > 1000 for real test
lastResult()$warnings
lastResult()$errors
``` 
...
PowerLMM1_Interaction45_20_Stark <- powerSim(lmm24_20_Stark, test=fixed("OrdPos.c:repet3","t"), nsim = n_iter) # increase to nsim > 1000 for real test
lastResult()$warnings
lastResult()$errors
``` 
...
fixef(lmm24_20)["OrdPos.c:repet2"]<- eff_50ms
fixef(lmm24_20)["OrdPos.c:repet3"]<- eff_50ms
```
...
PowerLMM1_Interaction50_20 <- powerSim(lmm24_20, test=fixed("OrdPos.c:repet2","t"), nsim = n_iter) # increase to nsim > 1000 for real test
lastResult()$warnings
lastResult()$errors
``` 
...
PowerLMM1_Interaction50_20 <- powerSim(lmm24_20, test=fixed("OrdPos.c:repet3","t"), nsim = n_iter) # increase to nsim > 1000 for real test
lastResult()$warnings
lastResult()$errors
``` 
...
fixef(lmm24_20)["OrdPos.c:repet2"]<- eff_55ms
fixef(lmm24_20)["OrdPos.c:repet3"]<- eff_55ms
```
...
PowerLMM1_Interaction55_20 <- powerSim(lmm24_20, test=fixed("OrdPos.c:repet2","t"), nsim = n_iter) # increase to nsim > 1000 for real test
lastResult()$warnings
lastResult()$errors
``` 
...
PowerLMM1_Interaction55_20 <- powerSim(lmm24_20, test=fixed("OrdPos.c:repet3","t"), nsim = n_iter) # increase to nsim > 1000 for real test
lastResult()$warnings
lastResult()$errors
``` 
...
```{r}
x <- summary(lmm1)
randomvars <-  0.0458500+0.0138126+0.0001718+0.0926834
...
gm <- mean(df_Ord$RT)
eff_45ms <- (1000/(gm+(45/2))) - (1000/(gm-(45/2)))
fixef(lmm24_20)["OrdPos.c:repet2"]<- eff_45ms
fixef(lmm24_20)["OrdPos.c:repet3"]<- eff_45ms
